(function(e, t, n) {
    ...
    function r(e, t, n) {
        ...
        return !/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(n) && /^-?\d/.test(n) && (i = s.left,
    ...
    function o(e, t, n, r, i, s) {
        ...
        if (o[0].toString().indexOf("%") !== -1)
            ...
            a = parseInt(o[0], 10);
        return o[1] === "auto" ? u = a / r.width * r.height : o[1].toString().indexOf("%") !== -1 ? (l = parseFloat(o[1]) / 100,
        u = n.height * l,
        e !== "backgroundSize" && (u -= (s || r).height * l)) : u = parseInt(o[1], 10),
        [a, u]
    }
    function u(e, t) {
        var n = [];
    ...
    f.Util.parseBackgroundImage = function(e) {
        var t = " \r\n	", n, r, i, s, o, u = [], a, f = 0, l = 0, c, h, p = function() {
            n && (r.substr(0, 1) === '"' && (r = r.substr(1, r.length - 2)),
            r && h.push(r),
            n.substr(0, 1) === "-" && (s = n.indexOf("-", 1) + 1) > 0 && (i = n.substr(0, s),
            n = n.substr(s)),
            u.push({
                prefix: i,
    ...
    f.Util.Bounds = function(e) {
        ...
        n.top = t.top,
        n.bottom = t.bottom || t.top + t.height,
        n.left = t.left,
            ...
            if (o)
                ...
                case "-o-linear-gradient":
                    ...
                    if (a) {
                        ...
                        l = 1 / Math.max(f - 1, 1);
                        for (r = 0; r < f; r += 1)
                            c = a[r].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
                            c[2] ? (u = parseFloat(c[2]),
                            c[3] === "%" ? u /= 100 : u /= t.width) : u = r * l,
                            n.colorStops.push({
                                color: c[1],
                                stop: u
                            })
                ...
                case "-webkit-gradient":
                    ...
                    a && (n.x0 = a[1] * t.width / 100,
                    n.y0 = a[2] * t.height / 100,
                    n.x1 = a[3] * t.width / 100,
                    n.y1 = a[4] * t.height / 100),
                    a = o[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g);
                    if (a) {
                        f = a.length;
                        for (r = 0; r < f; r += 1)
                            c = a[r].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),
                            u = parseFloat(c[2]),
                            c[1] === "from" && (u = 0),
                            c[1] === "to" && (u = 1),
                            n.colorStops.push({
                ...
                case "-moz-linear-gradient":
                    ...
                    if (a) {
                        ...
                        l = 1 / Math.max(f - 1, 1);
                        for (r = 0; r < f; r += 1)
                            c = a[r].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),
                            c[2] ? (u = parseFloat(c[2]),
                            c[3] && (u /= 100)) : u = r * l,
                            n.colorStops.push({
                                color: c[1],
                ...
                case "-o-radial-gradient":
                    ...
                    a = o[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),
                    a && (n.cx = a[1] * t.width / 100,
                    n.cy = a[2] * t.height / 100),
                    a = o[3].match(/\w+/),
                    c = o[4].match(/[a-z\-]*/);
                    if (a && c)
                        switch (c[0]) {
                        ...
                        case "closest-corner":
                            ...
                            break;
                        case "farthest-side":
                            a[0] === "circle" ? n.rx = n.ry = Math.max(n.cx, n.cy, n.x1 - n.cx, n.y1 - n.cy) : (n.type = a[0],
                            n.rx = Math.max(n.cx, n.x1 - n.cx),
                            n.ry = Math.max(n.cy, n.y1 - n.cy));
                            break;
                        case "closest-side":
                        case "contain":
                            a[0] === "circle" ? n.rx = n.ry = Math.min(n.cx, n.cy, n.x1 - n.cx, n.y1 - n.cy) : (n.type = a[0],
    ...
    f.Parse = function(r, i) {
        ...
        function c(e, t, n, r, i, s) {
            s !== "transparent" && (e.setVariable("fillStyle", s),
            e.fillRect(t, n, r, i),
            ft += 1)
        }
        function h(e, t, n) {
        ...
        function v(e, t, n, r) {
            e !== null  && ct.trimText(e).length > 0 && (r.fillText(e, t, n),
            ft += 1)
        }
        function m(e, t, n, r) {
            var i = !1
            ...
            a.length && (e.setVariable("shadowColor", a[0].color),
            e.setVariable("shadowOffsetX", a[0].offsetX),
            e.setVariable("shadowOffsetY", a[0].offsetY),
            e.setVariable("shadowBlur", a[0].blur));
            if (n !== "none")
                return ct.Font(o, u, lt)
        }
        ...
        function y(e, t, n, r, i) {
            var s;
            if (ht.rangeBounds && !i) {
                if (n !== "none" || ct.trimText(t).length !== 0)
                    s = b(t, e.node, e.textOffset);
        ...
        function E(e, t, n) {
            ...
            ct.trimText(t.nodeValue).length > 0 && (t.nodeValue = p(t.nodeValue, vt(e, "textTransform")),
            u = u.replace(["-webkit-auto"], ["auto"]),
            f = !i.letterRendering && /^(left|right|justify|auto)$/.test(u) && d(vt(e, "letterSpacing")) ? t.nodeValue.split(/(\b| )/) : t.nodeValue.split(""),
            a = m(r, e, o, s),
            i.chinese && f.forEach(function(e, t) {
                /.*[\u4E00-\u9FA5].*$/.test(e) && (e = e.split(""),
                e.unshift(t, 1),
                f.splice.apply(f, e))
            }),
            f.forEach(function(e, t) {
                var i = y(l, e, o, t < f.length - 1, n.transform.matrix);
                i && (v(e, i.left, i.bottom, r),
                g(r, o, i, a, s))
            }))
        }
        function S(e, t) {
        ...
        function N(e, t, n) {
            ...
            if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(o)) {
                ...
                if (vt(e, "listStylePosition") !== "inside")
                    return;
        ...
        function D(e, t, n, r, i, s, o) {
            t[0] > 0 || t[1] > 0 ? (e.push(["line", r[0].start.x, r[0].start.y]),
            r[0].curveTo(e),
            r[1].curveTo(e)) : e.push(["line", s, o]),
            (n[0] > 0 || n[1] > 0) && e.push(["line", i[0].start.x, i[0].start.y])
        }
        function P(e, t, n, r, i, s, o) {
            var u = [];
            return t[0] > 0 || t[1] > 0 ? (u.push(["line", r[1].start.x, r[1].start.y]),
            r[1].curveTo(u)) : u.push(["line", e.c1[0], e.c1[1]]),
            n[0] > 0 || n[1] > 0 ? (u.push(["line", s[0].start.x, s[0].start.y]),
            s[0].curveTo(u),
            u.push(["line", o[0].end.x, o[0].end.y]),
            o[0].curveToReversed(u)) : (u.push(["line", e.c2[0], e.c2[1]]),
            u.push(["line", e.c3[0], e.c3[1]])),
            t[0] > 0 || t[1] > 0 ? (u.push(["line", i[1].end.x, i[1].end.y]),
            i[1].curveToReversed(u)) : u.push(["line", e.c4[0], e.c4[1]]),
            u
        }
        function H(e, t, n) {
            var r = e.left
        ...
        function I(e, t, n) {
            n !== "transparent" && (e.setVariable("fillStyle", n),
            F(e, t),
            e.fill(),
            ft += 1)
        }
        function q(e, t, n) {
            ...
            if (/^(submit|reset|button|text|password)$/.test(e.type) || e.nodeName === "SELECT")
                r.style.lineHeight = vt(e, "height");
        ...
        function W(e, t) {
            ...
            if (!n && !r)
                return;
            n && (e.className += " " + mt + "-before",
            e.parentNode.insertBefore(n, e),
            st(n, t, !0),
            e.parentNode.removeChild(n),
            e.className = e.className.replace(mt + "-before", "").trim()),
            r && (e.className += " " + mt + "-after",
            e.appendChild(r),
            st(r, t, !0),
            e.removeChild(r),
            e.className = e.className.replace(mt + "-after", "").trim())
        }
        function X(e, t, n, r) {
        ...
        function K(e, t, n) {
            ...
            while (o--) {
                ...
                if (!r.args || r.args.length === 0)
                    continue;var u = r.method === "url" ? r.args[0] : r.value;
                s = C(u),
        ...
        function rt(e, t, n, r) {
            ...
            f.save(),
            f.clip(),
            l.height > 0 && l.width > 0 && !r ? ($(f, s, h),
            K(e, l, f)) : r && (u.backgroundColor = h),
            f.restore(),
    ...
    f.Preload = function(r) {
        ...
        function s() {
            ...
            !v.firstRun && v.numLoaded >= v.numTotal && (g.log("Finished loading images: # " + v.numTotal + " (failed: " + v.numFailed + ")"),
            typeof r.complete == "function" && r.complete(v))
        }
        function o(t, i, o) {
            var u, a = r.proxy, f;
            N.href = t,
            ...
            e[u] = function(t) {
                t.substring(0, 6) === "error:" ? (o.succeeded = !1,
                v.numLoaded++,
                v.numFailed++,
                s()) : (d(i, o),
                i.src = t),
        ...
        function h(e, t) {
            ...
            f.Util.parseBackgroundImage(e).filter(c).forEach(function(e) {
                e.method === "url" ? y.loadImage(e.args[0]) : e.method.match(/\-?gradient$/) && (r === n && (r = f.Util.Bounds(t)),
                l(e.value, r))
            })
        }
        function p(e) {
        ...
        y = {
            loadImage: function(e) {
                var t, s;
                e && v[e] === n && (t = new Image,
                e.match(/data:image\/.*;base64,/i) ? (t.src = e.replace(/url\(['"]{0,}|['"]{0,}\)$/ig, ""),
                s = v[e] = {
                    img: t
                },
                v.numTotal++,
                d(t, s)) : i(e) || r.allowTaint === !0 ? (s = v[e] = {
                    img: t
                },
                v.numTotal++,
                d(t, s),
                t.src = e) : C && !r.allowTaint && r.useCORS ? (t.crossOrigin = "anonymous",
                s = v[e] = {
                    img: t
                },
                v.numTotal++,
                d(t, s),
                t.src = e) : r.proxy && (s = v[e] = {
                    img: t
                },
                v.numTotal++,
                o(e, t, s)))
                    ...
                    for (u in v)
                        if (v.hasOwnProperty(u)) {
                            ...
                            if (typeof o == "object" && o.callbackname && o.succeeded === n) {
                                ...
                                o.script && o.script.parentNode && (o.script.setAttribute("src", "about:blank"),
                                o.script.parentNode.removeChild(o.script)),
                                v.numLoaded++,
                                v.numFailed++,
        ...
        for (b = 0; b < T; b += 1)
            y.loadImage(x[b].getAttribute("src"));
        return v.firstRun = !1,
    ...
    f.Renderer = function(e, r) {
            ...
            return i = function(e) {
                function t(e, r, i) {
                    ...
                    if (r.zIndex.ownStacking)
                        ...
                        l = f.children = [];
                    s === 0 && i ? i.push(f) : (e[s] || (e[s] = []),
                    e[s].push(f)),
                    r.zIndex.children.forEach
                    (function(e) {
                        t(o, e, l)
                    })
                }
        ...
        function s(e) {
            var t;
            if (typeof r.renderer == "string" && f.Renderer[e] !== n)
                t = f.Renderer[e](r);
            else {
    ...
    e.html2canvas = function(t, n) {
        ...
        s.complete = function(e) {
            if (typeof s.onpreloaded == "function" && s.onpreloaded(e) === !1)
                return;
            r = f.Parse(e, s);
            if (typeof s.onparsed == "function" && s.onparsed(r) === !1)
                return;
            i = f.Renderer(r, s),
    ...
    f.Renderer.Canvas = function(e) {
        ...
        return function(e, t, r, i, o) {
            ...
            i.forEach(function(e) {
                ...
                u.save(),
                e.transform.matrix && (u.translate(e.transform.origin[0], e.transform.origin[1]),
            ...
            t.elements.length === 1 && typeof t.elements[0] == "object" && t.elements[0].nodeName !== "BODY" ? (f = o.Util.Bounds(t.elements[0]),
            a = r.createElement("canvas"),
            a.width = Math.ceil(f.width),
            a.height = Math.ceil(f.height),
            u = a.getContext("2d"),
            u.drawImage(h, f.left, f.top, f.width, f.height, 0, 0, f.width, f.height),
            h = null ,
            a) : h
        }
    }
    ...
    return function(e) {
        ...
        for (var l = 0; l < r; l++) {
            ...
            for (var c = 0; c < i; c++) {
                o[l][c] = 0;
                var h = (c * r + l) * 4;
                f[h] < 255 || f[h + 1] < 255 || f[h + 2] < 255 ? (s[l][c] = !0,
                f[h] = f[h + 1] = f[h + 2] = 255) : f[h] = f[h + 1] = f[h + 2] = 0
            }
        }
...
Snowflakes = function() {
    ...
    function r() {
        for (var e = 0; e < o.length; e++) {
            ...
            t.o < T && (t.o = T);
            var u = !1;
            t.y > v.height + d / 2 && (t.y = 0,
            u = !0),
            t.y < 0 && (t.y = v.height,
            u = !0),
            t.x > v.width + p / 2 && (t.x = 0,
            u = !0),
            t.x < 0 && (t.x = v.width,
            u = !0),
            u && (t.nl = !1)
